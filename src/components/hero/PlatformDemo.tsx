...
import { Search, Filter, Clock, Phone, MessageCircle, User, ChevronDown, MoreHorizontal } from 'lucide-react';
...
const PlatformDemo = () => {
  ...
  return (
    <div className="relative max-w-6xl mx-auto mb-20">
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-sm bg-white">
        {/* Header */}
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-[#422D6D] flex items-center justify-center">
                  <span className="text-white font-bold text-sm">JU</span>
                </div>
                <span className="font-semibold text-gray-900">Ju - sua assistente</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-500">Advogados associados</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border-b border-gray-200 px-6">
          <div className="flex space-x-8">
            <div className="flex items-center py-3 text-[#422D6D] border-b-2 border-[#422D6D]">
              <MessageCircle className="w-4 h-4 mr-2" />
              <span className="font-medium">Conversas</span>
            </div>
            <div className="flex items-center py-3 text-gray-500 hover:text-gray-700">
          ...
          <div className="w-64 bg-gray-50 border-r border-gray-200 p-4">
            ...
            <div className="mt-6 p-3 bg-white rounded-lg border">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-medium text-gray-900">Dra. Mariana Gomes</div>
